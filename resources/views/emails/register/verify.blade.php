                            ...
                            <tr>
                                ...
                                <td>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tbody>
                                        <tr>
                                            <td style="padding-bottom: 20px; font:14px Arial, sans-serif; line-height:18px; color: #1f2326;" valign="top">
                                                Please click the button below to verify your email address.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom: 20px; font:14px Arial, sans-serif; line-height:18px; color: #1f2326;" align="center" valign="top">
                                                <a
                                                    href="{{ $verificationUrl }}"
                                                    target="_blank"
                                                    style="color: #fff !important; display: inline-block; padding: 15px 20px; font:14px Arial, sans-serif; line-height:18px; font-weight: bold; text-decoration: none; border-radius: 4px; background-color: #F02040;">Verify Email Address</a>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 20px; font:14px Arial, sans-serif; line-height:20px; color: #1f2326;" valign="top">
                                                Sincerely,<br>
